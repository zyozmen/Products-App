...
import favService, { DEFAULT_TAX_RATE } from "../../services/FavoritesService";
...
class FavoritesComponent extends Component {
    ...
    componentDidMount() {
        this.unsubscribe = favService.subscribe((items) => this.setState({ items }));
    }
    ...
    handleRemove(productId) {
        favService.removeFromFavorites(productId);
    }
                ...
                <div className="col-lg-9 col-md-8">
                    <div className="row pb-3">
                        ...
                        {!loading && !error && products.length === 0 && (
                            <div className="col-12 text-center py-4"><h1>No hay Productos Favoritos</h1></div>
                        )}
